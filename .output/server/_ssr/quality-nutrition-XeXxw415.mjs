...
//#region node_modules/.nitro/vite/services/ssr/assets/quality-nutrition-XeXxw415.js
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "grid lg:grid-cols-12 gap-8 items-center rounded-3xl bg-gradient-to-br from-[#002144] via-[#003822] to-[#327411] p-8 md:p-14 text-white shadow-2xl overflow-hidden relative",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "Uncompromising Quality Assurance"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										className: "mt-6 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl",
										children: "Scientific Animal Nutrition & Quality Standard"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-6 text-lg leading-relaxed text-slate-200",
										children: "FeedRani is built on a foundation of zero-tolerance laboratory testing, NIR spectroscopy raw material verification, precision formulation, and bio-available mineral enrichment for Indian farm conditions."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
											...
											children: "Explore Feed Products →"
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "overflow-hidden rounded-2xl border-2 border-white/20 shadow-2xl h-80 lg:h-96",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: "Quality Process"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "mt-2 text-3xl font-extrabold text-[#002144] sm:text-4xl",
									children: "Our 4-Stage Quality Control System"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 text-slate-600 text-sm",
									children: "From raw grain arrival to final sealed 50kg bags, every batch is verified for nutritional accuracy."
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
							...
							].map((p, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "h-48 w-full overflow-hidden bg-slate-100 relative",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										src: p.img,
										alt: p.title,
										className: "h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "absolute top-3 left-3 rounded-full bg-[#002144]/90 backdrop-blur-md px-3 py-1 text-[10px] font-bold text-white shadow-sm",
										children: ["Stage ", p.step]
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "p-6",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-lg font-bold tracking-tight text-[#002144]",
										children: p.title
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-[11px] font-bold text-[#327411] uppercase tracking-wider",
											children: p.tag
										})
									})
								})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						className: "mx-auto max-w-[1400px] px-6 lg:px-8 mt-16",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-3xl bg-white p-8 md:p-14 border border-slate-200/80 shadow-sm grid lg:grid-cols-12 gap-10 items-center",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "lg:col-span-6 overflow-hidden rounded-2xl border border-slate-200",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-xs font-bold uppercase tracking-widest text-[#327411]",
										children: "Advanced Lab Tech"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "mt-2 text-3xl font-extrabold text-[#002144]",
										children: "NIR Spectroscopy & Wet Chemistry Testing"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 text-slate-600 text-sm leading-relaxed",
										children: "Conventional visual grain checking is insufficient for modern high-yield dairy and poultry farming. At FeedRani's central laboratory, Near-Infrared Spectroscopy (NIR) delivers real-time molecular moisture, crude protein, ether extract, and crude fiber readouts within seconds before raw materials are accepted into our manufacturing bins."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
										className: "mt-6 space-y-2.5 text-xs font-semibold text-slate-700",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													...
													children: "✓"
												}), " Real-time Mycotoxin & Aflatoxins B1 screening"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[#327411]",
													children: "✓"
												}), " Guaranteed bypass protein and energy density per batch"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[#327411]",
													children: "✓"
												}), " ISO 9001:2015 and BIS standards compliance"]
											})
										]
									})
								]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "border-b border-slate-100 pb-6 mb-8",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-xs font-bold uppercase tracking-widest text-[#327411]",
										children: "In-House Wet Lab Standards"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "mt-2 text-3xl font-extrabold text-[#002144]",
										children: "Analytical Testing Benchmarks"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-2 text-xs text-slate-500",
										children: "Every production run is tested against stringent BIS & ISO animal feed specifications."
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mt-2 text-sm font-extrabold text-[#327411]",
											children: item.limit
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: "Partner With FeedRani"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "mt-2 text-3xl font-extrabold sm:text-4xl",
									children: "Experience Higher Farm Returns with Proven Nutrition"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 max-w-xl mx-auto text-sm text-slate-200",
									children: "Join 10,000+ satisfied farmers and 500+ dealers who rely on FeedRani for consistent, high-yield feed solutions."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//#endregion
export { QualityNutritionPage as component };
