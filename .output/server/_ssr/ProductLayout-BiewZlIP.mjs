		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hidden items-center gap-6 font-['Plus_Jakarta_Sans'] text-[13px] font-semibold text-[#1e293b] lg:flex",
					children: [
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
								...
								className: "size-4 text-[#327411]",
								viewBox: "0 0 24 24",
								fill: "currentColor",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" })
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "hidden sm:inline font-['Plus_Jakarta_Sans'] text-xs font-semibold",
								children: "Call Us"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Become a Dealer" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" })]
						}),
...
function Footer() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "border-t border-slate-200 bg-slate-100 py-16 text-slate-900 font-['Plus_Jakarta_Sans']",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-2 text-3xl font-extrabold tracking-tight text-[#002144] sm:text-4xl",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
								...
								className: "mt-4 text-sm leading-relaxed text-slate-600 border-t border-slate-100 pt-4",
								children: "FeedRani feeds are formulated by specialized veterinary nutritionists utilizing high-digestibility ingredients, organic trace minerals, phytase enzymes, and mycotoxin binders to deliver maximum Feed Conversion Ratio (FCR) and immunity."
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
							className: "group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all [&_summary::-webkit-details-marker]:hidden",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
								className: "flex cursor-pointer items-center justify-between font-bold text-[#002144] text-base",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "How can I become an authorized FeedRani distributor or dealer?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "ml-4 shrink-0 text-[#327411] transition-transform duration-300 group-open:-rotate-180",
									children: "▼"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 text-sm leading-relaxed text-slate-600 border-t border-slate-100 pt-4",
								children: "You can apply for dealership support by clicking the \"Become a Dealer\" button on our header or reaching our sales team directly at +91 7544000912 / care@feedrani.in. We offer competitive dealer margins, logistics support, and marketing assistance."
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
							className: "group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all [&_summary::-webkit-details-marker]:hidden",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
								className: "flex cursor-pointer items-center justify-between font-bold text-[#002144] text-base",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "What product categories does FeedRani offer?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "ml-4 shrink-0 text-[#327411] transition-transform duration-300 group-open:-rotate-180",
									children: "▼"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 text-sm leading-relaxed text-slate-600 border-t border-slate-100 pt-4",
								children: "FeedRani manufactures high-performance feeds across 4 major livestock divisions: Poultry Feed (Layer & Broiler), Aqua & Fish Feed (Floating Pellets), Cattle & Dairy Feed (Lactation & Bypass Fat), and Goat, Swine & Mineral Mixtures."
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
							className: "group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all [&_summary::-webkit-details-marker]:hidden",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", {
								className: "flex cursor-pointer items-center justify-between font-bold text-[#002144] text-base",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Are FeedRani feeds tested for safety and quality standards?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "ml-4 shrink-0 text-[#327411] transition-transform duration-300 group-open:-rotate-180",
									children: "▼"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 text-sm leading-relaxed text-slate-600 border-t border-slate-100 pt-4",
								children: "Yes, every batch undergoes rigorous Near-Infrared (NIR) chemical testing, toxin screening, and moisture verification in ISO 9001 certified manufacturing facilities to ensure safety and consistent performance."
							})]
						})
					]
				})]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
			className: "border-t border-gray-200 bg-[#002144] py-16 text-white relative",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-white opacity-30" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
						className: "w-7 h-7 relative z-10",
						viewBox: "0 0 24 24",
						fill: "currentColor",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
							fill: "#FFF",
							d: "M12.004 2C6.48 2 2 6.48 2 12.004c0 1.83.496 3.55 1.36 5.038L2 22l5.09-1.332A9.957 9.957 0 0 0 12.004 22C17.52 22 22 17.52 22 12.004 22 6.48 17.52 2 12.004 2Z"
					...
					className: "hidden sm:inline font-['Plus_Jakarta_Sans'] text-xs font-bold uppercase tracking-wider text-white pr-2",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: "mt-4 text-xs leading-relaxed text-gray-300",
								children: "Scientifically formulated livestock nutrition engineered for Indian farm conditions. Higher yields, improved health, superior conversion."
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							...
							className: "mt-4 space-y-2 text-xs text-gray-300",
							children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							...
							className: "mt-4 space-y-2 text-xs text-gray-300",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "ISO 9001 Certified" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Mycotoxin Screened" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "NIR Chemical Tested" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Custom Formulations" })
							]
						})] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							className: "text-xs font-bold uppercase tracking-wider text-[#8ec44a]",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
								className: "text-xs font-bold uppercase tracking-wider text-[#8ec44a]",
								children: "Dealer Inquiries"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 text-xs text-gray-300",
								children: "Reach out to our animal nutritionists and regional distribution hubs."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "💬 WhatsApp Sales" })
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/contact",
					...
					className: "mt-12 border-t border-white/10 pt-8 flex flex-col items-center justify-between gap-3 text-center text-xs text-gray-400 sm:flex-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						"© ",
						(/* @__PURE__ */ new Date()).getFullYear(),
						" FeedRani Agricultural Solutions. All rights reserved."
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									...
									children: "Webflora Technologies"
								})
							] })
						]
					})]
