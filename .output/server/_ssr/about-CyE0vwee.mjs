...
//#region node_modules/.nitro/vite/services/ssr/assets/about-CyE0vwee.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										to: "/products",
										className: "mt-4 inline-block text-xs font-bold text-[#327411] hover:underline",
										children: "View All Product Lines →"
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-3xl bg-white p-8 md:p-12 border border-slate-200/80 shadow-sm",
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										to: "/contact",
										className: "mt-4 inline-block text-xs font-bold text-[#327411] hover:underline",
										children: "Connect With Distribution Team →"
									})
								]
							})]
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
						className: "mx-auto max-w-[1400px] px-6 lg:px-8 mt-16",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-3xl bg-[#002144] p-8 md:p-12 text-white shadow-xl",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									...
									children: "Explore Our Livestock Feed Range"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-2 text-xs text-slate-300",
									children: "Discover scientifically tested feeds tailored for every species and growth stage."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "mt-2 inline-block text-xs font-bold text-[#8ec44a]",
													children: "Explore Dairy Range →"
												})
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
